...
def make_generation_stage(cuda_index: int | None = None):
    ...
    def generate(req: dict[str, Any]):
        ...
        return {"output_ids": output_ids, **req}

    def postprocess(req: dict[str, Any]):
        output_ids = req.pop("output_ids")
        inputs = req.pop("inputs")
    ...
    return [preprocess, generate, postprocess]
...
async def lifespan(app: FastAPI):
    model_pre, model_gen, model_post = make_generation_stage()
